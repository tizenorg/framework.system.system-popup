...
#define BATTERY_FULL_INDICATOR_ICON_PATH	SYSTEM_ICONDIR"/B03_stat_sys_battery_full.png"
#define DEV_NOTI_LOCALE_DIR		"/usr/share/locale"
#define DEV_NOTI_PACKAGE_NAME		"system-apps"
...
static int create_noti(void)
{
	...
	err = notification_set_text_domain(noti,
			DEV_NOTI_PACKAGE_NAME, DEV_NOTI_LOCALE_DIR);
